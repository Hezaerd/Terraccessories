...
public class ModBlock implements BlockRegistryContainer {
    ...
    public static final class Entities implements BlockEntityRegistryContainer {
        ...
        public static final BlockEntityType<TinkererWorkshopEntity> TINKERER_WORKSHOP = FabricBlockEntityTypeBuilder.create(TinkererWorkshopEntity::new, ModBlock.TINKERER_WORKSHOP).build();
    }
}
